...
export function ProductCardSkeleton() {
  return (
    <div className={`${shimmer} relative rounded-lg bg-white shadow-md overflow-hidden`}>
      <div className="h-48 bg-gray-100"></div>
      <div className="p-4">
        <div className="h-6 w-3/4 rounded bg-gray-100 mb-2"></div>
        <div className="h-5 w-1/2 rounded bg-gray-100 mb-4"></div>
